  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <form id="affliate-myprofile-validate" action="{{url('affiliate/submitProfile/'.auth()->user()->id)}}" method="POST" enctype=multipart/form-data>
            @csrf
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input
                    ...
                    id="aff-center-id"
                    name="aff-center-id"
                    value="{{$profile->center_id}}" readonly
                  />
                  @error('aff-center-id')
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input
                    ...
                    value="{{$profile->samanwiedu_id}}" readonly
                  />
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input
                    ...
                    id="aff-inst-name"
                    name="aff-inst-name"
                    value="{{$profile->inst_name}}" readonly
                  />
                  @error('aff-inst-name')
                    <div class="fv-plugins-message-container invalid-feedback">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 mt-2 display-5">
                @if ($stateName)
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <fieldset class="form-group position-relative has-icon-left">
                    ...
                    @enderror" name="register_date" placeholder="Select Date" value="{{$profile->register_dt}}" readonly>
                    @error('register_date')
                      <div class="fv-plugins-message-container invalid-feedback">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 mt-2 display-5">
                @if ($profile != null)
                  <img src="{{ asset('storage/affiliates/'.$profile->profile_name) }}" alt="" title="" style="width: 100px; height: 100px;">
                @endif
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-sm-4 mt-2 display-5">
                @if ($profile->center_name != null)
                  <img src="{{ asset('storage/affiliates/'.$profile->center_name) }}" alt="" title="" style="width: 100px; height: 100px;">
                @endif
              </div>
            </div>
            <div class="row">
