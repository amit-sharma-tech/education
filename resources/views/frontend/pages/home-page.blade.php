@extends('frontend.layouts.commonTemplate')
...
<!-- Section: home -->
    ...
    <!-- Divider: Funfact -->
    <section class="divider parallax layer-overlay" data-bg-img="http://placehold.it/1920x1280" data-parallax-ratio="0.7">
    ...
    <!-- Section: events -->
    <section id="events" class="divider parallax layer-overlay overlay-dark-8" data-stellar-background-ratio="0.5" data-bg-img="http://placehold.it/1920x1280">
      <div class="container pt-70 pb-40">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 mb-30 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="pricing table-horizontal maxwidth400">
                <div class="row">
                  <div class="col-md-6">
                    <div class="thumb">
                    <img class="img-fullwidth mb-sm-0" src="http://placehold.it/270x250" alt="">
                    </div>
                  </div>
            ...
            <div class="col-md-12">
              ...
              <div class="gallery-isotope grid-4 gutter-small clearfix" data-lightbox="gallery">
                ...
                <div class="gallery-item campus">
                  <div class="thumb">
                    <img class="img-fullwidth" src="http://placehold.it/290x180" alt="project">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="http://placehold.it/290x180" data-lightbox-gallery="gallery" title="Your Title Here"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <!-- Section: Client Say -->
    <section class="divider parallax layer-overlay overlay-dark-4" data-background-ratio="0.5" data-bg-img="http://placehold.it/1920x1280">
            ...
            <div class="owl-carousel-1col" data-dots="true">
              <div class="item">
                <div class="testimonial-wrapper text-center">
                  <div class="thumb"><img class="" alt="" src="http://placehold.it/100x100"></div>
              ...
              <div class="item">
                <article class="post clearfix maxwidth600 mb-sm-30 wow fadeInRight" data-wow-delay=".2s">
                  <div class="entry-header">
                    <div class="post-thumb thumb"> <img src="http://placehold.it/370x247" alt="" class="img-responsive img-fullwidth"> </div>
